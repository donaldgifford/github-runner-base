...
**Solution:** This means the base image changed. Check the official runner image
...
**Solution:** This should be fixed by this image! Verify you're using the
correct image:
...
**Solution:** This image includes `build-essential`. If still failing, you may
...
2. Review
   [GitHub Actions runner requirements](https://docs.github.com/en/actions/hosting-your-own-runners)
